  ...
  return (
    <>
      <div className="home" id="home">
        <main>
          <h1>TechKriya</h1>
          <p>When NIT Andhra Pradesh hits peaks</p>
        </main>
      </div>
      ...
      <div className="home2">
        ...
        <div>
          <p>
            TechKriya: A technical fest introduced by NIT Andhra Pradesh to leverage the 
            talents of students by organizing myraid events from all over 18 Clubs and Associations
          </p>
        </div>
      </div>
